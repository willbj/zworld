...
import type { BookCreationDraft } from "@zworld/core";
...
const PAGE_COPY: Record<"zh" | "en", PlatformCopy> = {
  ...
  en: {
    ...
    idleBody: "Fill in the title, genre, and story core first. ZWorld will generate the foundation and open the new workspace.",
