...
const strings = {
  ...
  "nav.createPlay": { zh: "ZWorld 互动", en: "ZWorld Play" },
  ...
  "doctor.zworldJson": { zh: "zworld.json 配置", en: "zworld.json configuration" },
  "doctor.projectEnv": { zh: "项目 .env 文件", en: "Project .env file" },
  "doctor.globalEnv": { zh: "全局 ~/.zworld/.env", en: "Global ~/.zworld/.env" },
